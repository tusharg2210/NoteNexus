function ScrollToTopButton() {
    ...
    return (
        <button
            ...
            className="fixed bottom-4 right-4 p-2 fill-orange-500 rounded-full"
        >
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" className="bi bi-arrow-up-circle" viewBox="0 0 16 16">
