...
function HeroSection() {
    ...
    return (
        <div id='hero-section' className="max-w-full min-h-screen bg-gray-900 text-gray-200 flex flex-col md:flex-row">
            ...
            <div className="hero-section-text flex flex-col w-full md:w-1/2 min-h-[50vh] justify-center">
                <div className="flex flex-row px-4 sm:px-8 pt-8 items-center justify-center md:justify-start">
                    
                    {/* ✅ FIX: Added more responsive steps for tablet sizes (md, lg) */}
                    <div className="text-[8rem] sm:text-[10rem] md:text-[12rem] lg:text-[18rem] text-orange-500 hover:rotate-15 transition-transform duration-500 font-serif font-bold">
                        N
                    </div>
                    
                    <div className="text-5xl sm:text-6xl md:text-7xl lg:text-[6rem] tracking-widest flex flex-col mt-6 sm:mt-10 font-serif font-bold">
                ...
                <div className="px-8 sm:px-20 text-center md:text-left mt-4 md:mt-0">
